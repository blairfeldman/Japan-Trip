...
const QUICK = ['500', '1000', '3300', '10000'];
  ...
  return (
    <View style={styles.screen}>
      <View style={styles.header}>
        ...
        <Pressable
          onPress={() => dispatch({ type: 'SET_CONVERTER', patch: { dir: jpyFirst ? 'usd' : 'jpy', amount: '100' } })}
      ...
      <View style={styles.body}>
        ...
        <Text style={styles.fromValue} numberOfLines={1}>
          {(jpyFirst ? '¥' : '$') + (state.converter.amount === '' ? '0' : Number(state.converter.amount).toLocaleString())}
        </Text>
